...
const limitesPresentes = {
    ...
    "Copos de medidas + Espátula de silicone": 1,
    ...
    "Espátula": 1,
    "Espremedor de alho (Inox) + Galheteiro": 1,
    ...
    "Fruteira": 1,
    "Galheteiro": 1,
    "Garrafa térmica + Luva térmica": 1,
    ...
    "Pegador de massa Inox + Pegador de salada Inox": 1,
    "Pegador de salada Inox": 1,
    "Pilão de madeira + Saladeira": 1,
    "Porta frios + Porta tempero": 1,
    "Porta guardanapo + Tesoura de cozinha": 1,
    "Porta pão": 1,
    "Porta tempero": 1,
    "Potes de vidro com tampa (6 peças)": 2,
    "Potes p/ microondas (10 peças)": 1,
    "Protetor de colchão casal": 4,
    "Puxa saco + Rolo de abrir massa": 1,
    "Queijeira": 1,
    "Ralador": 1,
    "Rodo para pia": 1,
